...
def inference(model, args, rays_xyz, z_vals, rays_d=None, sun_d=None, rays_t=None, z_vals_unsort=None):
    ...
    nr_an_on = False
    if (model.normal == 'analystic_learned' or model.normal == 'analystic'):
...
class SatNeRF(torch.nn.Module):
    ...
    def __init__(self, layers=8, feat=256, mapping=False, mapping_sizes=[10, 4], skips=[4], siren=True, t_embedding_dims=16, beta=1, normal='none'):
